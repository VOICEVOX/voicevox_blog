...
curl -fsSL https://raw.githubusercontent.com/VOICEVOX/voicevox/0.25.1/build/installer_linux.sh >tmp_voicevox_installer.sh
VERSION=0.25.1 NAME=linux-cpu-arm64-appimage bash tmp_voicevox_installer.sh
