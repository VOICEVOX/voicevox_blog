...
curl -fsSL https://raw.githubusercontent.com/VOICEVOX/voicevox/0.11.2/build/installer_linux.sh >tmp_voicevox_installer.sh
VERSION=0.11.2 NAME=linux-nvidia-appimage bash tmp_voicevox_installer.sh
