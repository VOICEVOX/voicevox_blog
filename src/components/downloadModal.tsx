...
export const DownloadModal: React.FC<{
  ...
  > = {
    Windows: {
      "GPU / CPU": {
        インストーラー: {
          url: "https://github.com/VOICEVOX/voicevox/releases/download/0.13.2/VOICEVOX.Web.Setup.0.13.2.exe",
          name: "VOICEVOX.Setup.0.13.2.Windows.exe",
        },
        Zip: {
          url: "https://github.com/VOICEVOX/voicevox/releases/download/0.13.2/voicevox-windows-directml-0.13.2.zip",
          name: "VOICEVOX.0.13.2.Windows.zip",
        },
      },
      CPU: {
        インストーラー: {
          url: "https://github.com/VOICEVOX/voicevox/releases/download/0.13.2/VOICEVOX-CPU.Web.Setup.0.13.2.exe",
          name: "VOICEVOX-CPU.Setup.0.13.2.Windows.exe",
        },
        Zip: {
          url: "https://github.com/VOICEVOX/voicevox/releases/download/0.13.2/voicevox-windows-cpu-0.13.2.zip",
          name: "VOICEVOX-CPU.0.13.2.Windows.zip",
        },
      },
    },
    Mac: {
      CPU: {
        インストーラー: {
          url: "https://github.com/VOICEVOX/voicevox/releases/download/0.13.2/VOICEVOX.0.13.2.dmg",
          name: "VOICEVOX.0.13.2.Mac.dmg",
        },
        Zip: {
          url: "https://github.com/VOICEVOX/voicevox/releases/download/0.13.2/voicevox-macos-cpu-0.13.2.zip",
          name: "VOICEVOX-CPU.0.13.2.Mac.zip",
        },
      },
    },
    Linux: {
      "GPU / CPU": {
        インストーラー: {
          url: scriptNodes.find(value => value.name == "linuxInstallNvidia")!
            .publicURL,
          name: "VOICEVOX.Installer.0.13.2.Linux.sh",
        },
      },
      CPU: {
        インストーラー: {
          url: scriptNodes.find(value => value.name == "linuxInstallCpu")!
            .publicURL,
          name: "VOICEVOX-CPU.Installer.0.13.2.Linux.sh",
        },
        "tar.gz": {
          url: "https://github.com/VOICEVOX/voicevox/releases/download/0.13.2/voicevox-linux-cpu-0.13.2.tar.gz",
          name: "VOICEVOX-CPU.0.13.2.Linux.tar.gz",
        },
      },
    },
  }
